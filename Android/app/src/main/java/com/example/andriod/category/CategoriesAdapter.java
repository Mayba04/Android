...
import com.example.andriod.R;
import com.example.andriod.constants.Urls;
...
public class CategoriesAdapter extends RecyclerView.Adapter<CategoryCardViewHolder> {
    ...
    public CategoriesAdapter(List<CategoryItemDTO> items, OnItemClickListener deleteCatergory) {
        this.items = items;
        this.deleteCategory = deleteCatergory;
    }
